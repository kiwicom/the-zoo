...
class Migration(migrations.Migration):
    ...
    dependencies = [("auditing", "0015_auto_20180411_1603")]
        ...
        migrations.AlterField(
            ...
            field=models.CharField(
                choices=[
                    ...
                    ("py_security:exec_used", "py_security:exec_used"),
                    (
                        "py_security:set_bad_file_permissions",
                        "py_security:set_bad_file_permissions",
                    ),
                    ("py_security:flask_debug_true", "py_security:flask_debug_true"),
                    ("py_security:md5", "py_security:md5"),
                    ("py_security:ciphers", "py_security:ciphers"),
                    ("py_security:eval", "py_security:eval"),
                    ("py_security:input", "py_security:input"),
                    (
                        "py_security:hashlib_new_insecure_functions",
                        "py_security:hashlib_new_insecure_functions",
                    ),
                    ("py_security:import_telnetlib", "py_security:import_telnetlib"),
                    ("py_security:import_ftplib", "py_security:import_ftplib"),
                    ("py_security:import_pickle", "py_security:import_pickle"),
                    ("py_security:import_xmlrpclib", "py_security:import_xmlrpclib"),
                    ("py_security:import_httpoxy", "py_security:import_httpoxy"),
                    (
                        "py_security:request_with_no_cert_validation",
                        "py_security:request_with_no_cert_validation",
                    ),
                    (
                        "py_security:ssl_with_bad_version",
                        "py_security:ssl_with_bad_version",
                    ),
                    (
                    ...
                    ("py_security:yaml_load", "py_security:yaml_load"),
                    (
                        "py_security:subprocess_popen_with_shell_equals_true",
                        "py_security:subprocess_popen_with_shell_equals_true",
                    ),
                    (
                        "py_security:start_process_with_a_shell",
                        "py_security:start_process_with_a_shell",
                    ),
                    (
                        "py_security:hardcoded_sql_expressions",
                        "py_security:hardcoded_sql_expressions",
                    ),
                    (
                        "py_security:linux_commands_wildcard_injection",
                        "py_security:linux_commands_wildcard_injection",
                    ),
                    (
                        "py_security:jinja2_autoescape_false",
                        "py_security:jinja2_autoescape_false",
                    ),
                    (
